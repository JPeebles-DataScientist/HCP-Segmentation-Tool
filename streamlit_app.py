...
st.markdown("Segment HCPs using ZIP3-based clustering and visualize the results with an interactive map and summary table.")
...
# Clustering
features = hcp_df[["TRx", "ZIP3"]].copy()
features["ZIP3"] = features["ZIP3"].astype(int)
